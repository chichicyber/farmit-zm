...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-12 w-12 [&_svg]:size-7 md:hidden", className)}
      onClick={(event) => {
        onClick?.(event)
