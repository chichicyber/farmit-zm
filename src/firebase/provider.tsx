...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  const contextValue = useMemo((): FirebaseContextState => {
    ...
    return {
      ...
      messaging: servicesAvailable && messaging ? messaging : null,
 ...
 */
export const useFirebase = (): Omit<FirebaseServicesAndUser, 'messaging'> & { messaging: Messaging | null } => {
...
export const useMessaging = (): Messaging => {
    ...
    if (!messaging) throw new Error("Firebase Messaging is not available. Ensure it's supported and initialized.");
    return messaging;
};
